...
const DEFAULT_GRADIENT_TILT = 0;
const GRADIENT_MAX_ANGLE = 180;
...
const GradientSelectionPreview = memo(function GradientSelectionPreview({
  angleSignalRef,
  tiltSignalRef,
  popoverAnchorEl,
  onChangeAngles
  ...
  return (
    ...
    >
      ...
      <Box
        ...
        onPointerDown={onStartGradientHandlePointer('start')}
        ...
        sx={{
          position: 'absolute',
          left: `calc(var(--gradient-start-handle-center-x, ${DEFAULT_GRADIENT_PREVIEW_GEOMETRY.startCenterX}px) - ${GRADIENT_HANDLE_HIT_AREA_SIZE / 2}px)`,
          top: `calc(var(--gradient-start-handle-center-y, ${DEFAULT_GRADIENT_PREVIEW_GEOMETRY.startCenterY}px) - ${GRADIENT_HANDLE_HIT_AREA_SIZE / 2}px)`,
          zIndex: 3,
          display: 'flex',
          alignItems: 'center',
      ...
      >
        <Box
          component='span'
          sx={{
            width: `var(--gradient-start-handle-size, ${DEFAULT_GRADIENT_PREVIEW_GEOMETRY.startHandleSize})`,
            aspectRatio: '1 / 1',
            borderRadius: '50%',
            backgroundColor: gradientStartColor,
            border: '2px solid',
            borderColor: `rgba(255, 255, 255, var(--gradient-start-handle-outline-opacity, ${DEFAULT_GRADIENT_PREVIEW_GEOMETRY.startHandleOutlineOpacity}))`,
      ...
      <Box
        ...
        onPointerDown={onStartGradientHandlePointer('end')}
        onPointerMove={onDragGradientHandlePointer}
        onPointerUp={onEndGradientHandlePointer}
        onPointerCancel={onCancelGradientHandlePointer}
        sx={{
          position: 'absolute',
          left: `calc(var(--gradient-end-handle-center-x, ${DEFAULT_GRADIENT_PREVIEW_GEOMETRY.endCenterX}px) - ${GRADIENT_HANDLE_HIT_AREA_SIZE / 2}px)`,
          top: `calc(var(--gradient-end-handle-center-y, ${DEFAULT_GRADIENT_PREVIEW_GEOMETRY.endCenterY}px) - ${GRADIENT_HANDLE_HIT_AREA_SIZE / 2}px)`,
          zIndex: 3,
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'center',
      ...
      >
        <Box
          component='span'
          sx={{
            width: `var(--gradient-end-handle-size, ${DEFAULT_GRADIENT_PREVIEW_GEOMETRY.endHandleSize})`,
            aspectRatio: '1 / 1',
            borderRadius: '50%',
            backgroundColor: gradientEndColor,
            border: '2px solid',
            borderColor: `rgba(255, 255, 255, var(--gradient-end-handle-outline-opacity, ${DEFAULT_GRADIENT_PREVIEW_GEOMETRY.endHandleOutlineOpacity}))`,
            boxShadow: '0 2px 8px rgba(0, 0, 0, 0.35)',
            pointerEvents: 'none'
          }}
        />
        ...
        {!hasEditableVertices ? null : (
          <>
            ...
            <Box sx={{ mt: 1 }}>
              ...
              {colorEditMode !== 'gradientSelection' ? null : (
                <Box
                  sx={{
                    display: 'grid',
                    gap: 1.25
